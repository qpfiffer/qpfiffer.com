...
that we'd actually have two less days than we planned to do the whole trip.
...
We spend the day eyeing rapids, walking along the trali, baking in the sun and
...
Thanks for reading, I hope you enjoy the write-up. Thanks to Sockdolager for a
